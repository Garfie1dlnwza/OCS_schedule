    ...
    <div className="card">
      ...
      <div className="cardContent">
        <div className="courseInfo">
          <h3 className="courseName" title={courseName}>{courseName}</h3>
          <div className="locationInfo">
            ...
            <span className="roomText" title={`${room}`}>{room}</span>
          </div>
          {/* {instructor && (
            <div className="instructorInfo">
              <span className="instructorText" title={instructor}>{instructor}</span>
            </div>
          )} */}
        </div>
